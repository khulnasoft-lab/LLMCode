...
# Badge tooltip texts
GITHUB_STARS_TOOLTIP = "Total number of GitHub stars the Llmcode project has received"
...
def get_github_stars(repo="paul-gauthier/llmcode"):
    """
...
def get_latest_release_llmcode_percentage():
    """
    Get the percentage of code written by Llmcode in the LATEST release
    ...
    try:
        ...
        if latest_release:
            percentage = latest_release.get("llmcode_percentage", 0)
...
def generate_badges_md(downloads, stars, llmcode_percentage):
    """
...
src="https://img.shields.io/badge/🏆%20OpenRouter-Top%2020-9b59b6?style=flat-square&labelColor=555555"/></a>
  <a href="https://llm.khulnasoft.com/HISTORY.html"><img alt="Singularity" title="{SINGULARITY_TOOLTIP}"
src="https://img.shields.io/badge/🔄%20Singularity-{llmcode_percent_rounded}%25-e74c3c?style=flat-square&labelColor=555555"/></a>"""  # noqa
...
def get_badges_md():
    ...
    # Get Llmcode contribution percentage in latest release
    percentage, _ = get_latest_release_llmcode_percentage()
...
<a href="/HISTORY.html" class="github-badge badge-coded" title="{SINGULARITY_TOOLTIP}">
    ...
    <span class="badge-value">{llmcode_percent_rounded}%</span>
</a>"""  # noqa
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Get total downloads and GitHub stars for llmcode")
    parser.add_argument(
        "--api-key",
        help=(
    ...
    parser.add_argument(
        ...
        help="GitHub repository (default: paul-gauthier/llmcode)",
    )
    ...
    # Get Llmcode contribution percentage in latest release
    percentage, version = get_latest_release_llmcode_percentage()
    print(f"Llmcode wrote {percentage:.2f}% of code in the LATEST release ({version})")
