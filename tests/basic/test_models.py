...
class TestModels(unittest.TestCase):
    def setUp(self):
        ...
        from llmcode.models import MODEL_SETTINGS
    ...
    @patch("llmcode.models.check_for_dependencies")
    ...
    @patch("llmcode.models.check_pip_install_extra")
    def test_check_for_dependencies_bedrock(self, mock_check_pip):
        ...
        from llmcode.models import check_for_dependencies
    ...
    def test_llmcode_extra_model_settings(self):
        import tempfile
    ...
    @patch("llmcode.models.litellm.completion")
