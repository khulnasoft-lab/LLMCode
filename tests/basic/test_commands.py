...
class TestCommands(TestCase):
    ...
    def test_cmd_undo_with_dirty_files_not_in_last_commit(self):
        with GitTemporaryDirectory() as repo_dir:
            ...
            coder.llmcode_commit_hashes.add(last_commit_hash)
    ...
    def test_cmd_add_llmcodeignored_file(self):
        with GitTemporaryDirectory():
            ...
            repo = GitRepo(
                ...
                fnames,
                None,
                llmcode_ignore_file=str(aignore),
            )
    ...
    def test_cmd_model_preserves_explicit_edit_format(self):
        ...
        with mock.patch("llmcode.models.sanity_check_models"):
    ...
    def test_cmd_ask(self):
        ...
        with mock.patch("llmcode.coders.Coder.run") as mock_run:
