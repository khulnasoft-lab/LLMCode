...
class TestOnboarding(unittest.TestCase):
    ...
    @patch.dict(
        os.environ,
        {"OPENROUTER_API_KEY": "or_key", "OPENAI_API_KEY": "oa_key"},
        clear=True,
    )
    ...
    @patch.dict(
        os.environ,
        {"ANTHROPIC_API_KEY": "an_key", "OPENAI_API_KEY": "oa_key"},
        clear=True,
    )
    ...
    @patch(
        "llmcode.onboarding.try_to_select_default_model", side_effect=[None, None]
    ...
    @patch(
        "llmcode.onboarding.try_to_select_default_model",
    ...
    @patch("llmcode.onboarding.start_openrouter_oauth_flow", return_value="new_or_key")
