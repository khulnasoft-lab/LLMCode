...
can also
[download from GitHub](https://github.com/khulnasoft-lab/llmcode/blob/main/llmcode/website/assets/sample.env).
...
# See https://llm.khulnasoft.com/docs/llms.html for details.
...
#LLMCODE_AUTO_ACCEPT_ARCHITECT=true
...
#LLMCODE_CHECK_MODEL_ACCEPTS_SETTINGS=true
...
#LLMCODE_ADD_GITIGNORE_FILES=false
...
#LLMCODE_ATTRIBUTE_CO_AUTHORED_BY=true

## Enable/disable git pre-commit hooks with --no-verify (default: False)
#LLMCODE_GIT_COMMIT_VERIFY=false
...
#LLMCODE_ANALYTICS_POSTHOG_HOST=

## Send analytics to custom PostHog project
#LLMCODE_ANALYTICS_POSTHOG_PROJECT_API_KEY=
...
#LLMCODE_DISABLE_PLAYWRIGHT=false
