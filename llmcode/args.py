...
def get_parser(default_config_files, git_root):
    ...
    from llmcode import coders as _llmcode_coders

    edit_format_choices = sorted(
        {
            c.edit_format
            for c in _llmcode_coders.__all__
    ...
    group.add_argument(
        ...
        help="Specify a file with llmcode model settings for unknown models",
    ).complete = shtab.FILE
    group.add_argument(
        "--model-metadata-file",
    ...
    group.add_argument(
        ...
        default=None,
        help="Log the conversation with the LLM to this file (for example, .llmcode.llm.history)",
    ).complete = shtab.FILE
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Enable/disable adding .llmcode* to .gitignore (default: True)",
    )
    group.add_argument(
        "--add-gitignore-files",
        action=argparse.BooleanOptionalAction,
    ...
    group.add_argument(
        "--llmcodeignore",
        metavar="LLMCODEIGNORE",
        type=lambda path_str: resolve_llmcodeignore_path(path_str, git_root),
        default=default_llmcodeignore_file,
        help="Specify the llmcode ignore file (default: .llmcodeignore in git root)",
    ).complete = shtab.FILE
    group.add_argument(
        "--subtree-only",
        action="store_true",
    ...
    group.add_argument(
        ...
        default=None,
        help=(
            "Attribute llmcode commits in the git committer name (default: True). If explicitly set"
            " to True, overrides --attribute-co-authored-by precedence for llmcode edits."
        ),
    )
    group.add_argument(
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix all commit messages with 'llmcode: ' (default: False)",
    )
    group.add_argument(
        ...
        default=True,
        help=(
            "Attribute llmcode edits using the Co-authored-by trailer in the commit message"
    ...
    group.add_argument(
        "--check-update",
        action=argparse.BooleanOptionalAction,
        help="Check for new llmcode versions on launch",
        default=True,
    )
    group.add_argument(
        "--show-release-notes",
    ...
    group.add_argument(
        ...
        "--update",
        action="store_true",
        help="Upgrade llmcode to the latest version from PyPI",
        default=False,
    )
    group.add_argument(
        "--version",
    ...
    group.add_argument(
        ...
        "--browser",
        action=argparse.BooleanOptionalAction,
        help="Run llmcode in your browser (default: False)",
        default=False,
    )
    group.add_argument(
        "--copy-paste",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Enable automatic copy/paste of chat between llmcode and web UI (default: False)",
    )
    group.add_argument(
        "--apply",
        metavar="FILE",
    ...
    group.add_argument(
        ...
        metavar="CONFIG_FILE",
        help=(
            "Specify the config file (default: search for .llmcode.conf.yml in git root, cwd"
            " or home directory)"
        ),
    ).complete = shtab.FILE
    ...
    group.add_argument(
        ...
        help=(
            ...
            f" {', '.join(supported_shells_list)}. Example: llmcode --shell-completions bash"
        ),
    )
