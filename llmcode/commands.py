...
class Commands:
    ...
    def cmd_undo(self, args):
        "Undo the last git commit if it was done by llmcode"
        try:
    ...
    def cmd_help(self, args):
        ...
        from llmcode.coders.base_coder import Coder
        ...
        user_msg += """
# Announcement lines from when this session of llmcode was launched:
...
"""
    ...
    def cmd_report(self, args):
        ...
        from llmcode.report import report_github_issue
